...
func ApplicationTargetImageReconciler(c reconcilers.Config) reconcilers.SubReconciler {
...
func ApplicationChildImageReconciler(c reconcilers.Config) reconcilers.SubReconciler {
